...
% Last Modified by GUIDE v2.5 14-Nov-2017 23:21:07
...
global infoo 
global f
set(handles.edit1,'string',infoo.Format)
set(handles.edit2,'string',infoo.Height)
set(handles.edit3,'string',infoo.Width)
set(handles.edit4,'string',size(f,3))
set(handles.edit5,'string',class(f))
set(handles.edit6,'string',infoo.BitDepth)
